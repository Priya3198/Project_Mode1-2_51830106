...
/*
	@PostConstruct
	public void init() {
		userService.addUser(new User("raja", "raja@raja.com", "raja123", "admin",
				true));
		userService.addUser(new User("priya", "priya@gmail.com", "priya123", "mgr",
				true));
		userService.addUser(new User("shahana", "shahana@gmail.com", "shahana123",
				"emp", true));
	}*/
